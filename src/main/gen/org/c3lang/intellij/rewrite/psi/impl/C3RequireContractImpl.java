...
public class C3RequireContractImpl extends ASTWrapperPsiElement implements C3RequireContract {

  public C3RequireContractImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull C3Visitor visitor) {
    visitor.visitRequireContract(this);
  }
